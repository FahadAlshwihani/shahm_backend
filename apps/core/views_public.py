...
from apps.settings_app.serializers import SiteSettingsSerializer

# CMS
from apps.cms.models import HeroSection, FooterColumn, Page, HeaderLink
...
from apps.blog.serializers_public import PublicBlogPostSerializer
...
from apps.legal.serializers import LegalPageSerializer

# SEO
from apps.seo.models import DefaultSEO, PageSEO
from apps.seo.serializers import DefaultSEOSerializer, PageSEOSerializer
