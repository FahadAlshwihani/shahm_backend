...
from services.models import PracticeArea
...
class AllPagesForSEO(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            print("SEO AllPagesForSEO CMS error:", e)
        ...
        try:
            ...
            print("SEO AllPagesForSEO LEGAL error:", e)
        ...
        try:
            ...
            print("SEO AllPagesForSEO SERVICES error:", e)
        ...
        try:
            ...
            print("SEO AllPagesForSEO BLOG error:", e)
        ...
        try:
            ...
            print("SEO AllPagesForSEO TEAM error:", e)
